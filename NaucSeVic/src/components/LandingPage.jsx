...
const LandingPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      {/* Content Overlay */}
      <div className="relative z-10 max-full mx-auto h-screen flex items-center text-center">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-2xl w-full md:w-1/2 text-start">
          <h1 className="text-6xl font-bold text-gray-900 ">
            Pro všechny, kdo chtějí<br></br> víc než{" "}
            <span className="text-indigo-600">učebnici.</span>
          </h1>
          <p className="mt-6 text-2xl text-gray-700 w-2/3">
            Objevte nový způsob, jak se učit – rychleji, chytřeji a zábavněji,
            ať už doma, ve škole nebo na cestách.Objevte nový způsob, jak se{" "}
          </p>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="text-center p-8 rounded-xl bg-gradient-to-b from-blue-50 to-indigo-50 hover:shadow-lg transition duration-300">
            ...
            {/* Feature 2 */}
            <div className="text-center p-8 rounded-xl bg-gradient-to-b from-green-50 to-emerald-50 hover:shadow-lg transition duration-300">
            ...
            {/* Feature 3 */}
            <div className="text-center p-8 rounded-xl bg-gradient-to-b from-purple-50 to-violet-50 hover:shadow-lg transition duration-300">
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-indigo-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-indigo-700 transition duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
              Get Started Now
            </button>
            <button className="text-indigo-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-indigo-50 transition duration-300">
              Learn More →
            </button>
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-white py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-2xl font-bold mb-4">NaucSeVic</h3>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400">
              © 2025 NaucSeVic. All rights reserved. Built with React and
              Tailwind CSS.
            </p>
          </div>
        </div>
