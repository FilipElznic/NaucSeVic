const StarBorder = ({
  ...
  return (
    ...
    >
      ...
      ></div>
      <div className="relative z-1 bg-gradient-to-b from-white to-gray-100 dark:from-black dark:to-gray-900 border border-gray-300 dark:border-gray-800 text-gray-900 dark:text-white text-center text-[16px] py-[16px] px-[26px] rounded-[20px]">
        {children}
      </div>
    </Component>
  );
