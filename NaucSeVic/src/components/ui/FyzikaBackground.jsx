...
const CPPNShaderMaterial = shaderMaterial(
  { iTime: 0, iResolution: new THREE.Vector2(2, 2) },
  vertexShader,
  fragmentShader
);
...
function ShaderPlane() {
  ...
  return (
    <mesh ref={meshRef} position={[0, -1.2, 4]}>
...
export default function Hero({
  title = "Neural Network Surfaces",
  description = "Experience generative art powered by compositional pattern-producing networks. Real-time GPU-accelerated visuals that evolve dynamically.",
