    ...
    <div className="min-h-screen bg-white dark:bg-black relative overflow-hidden py-20">
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-[30%_70%] gap-8 items-center">
          ...
          <div className="relative h-[60vh] lg:ml-16">
            <CardSwap
              cardDistance={60}
              verticalDistance={70}
              delay={3500}
            ...
            >
              {/* Card 1 */}
              <Card className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 shadow-2xl p-8 backdrop-blur-sm">
