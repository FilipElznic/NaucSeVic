                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center mb-3">
                      <div className={`${currentSubject.bgColor} p-2 rounded-lg mr-4`}>
                        {task.completed ? (
                          <CheckCircle className={`h-6 w-6 ${currentSubject.iconColor}`} />
                        ) : task.locked ? (
                          <Lock className="h-6 w-6 text-gray-400 dark:text-zinc-500" />
                        ) : (
                          <BookOpen className={`h-6 w-6 ${currentSubject.iconColor}`} />
                        )}
                      </div>
                      <div>
                  ...
                  <div className="ml-6">
                    {task.locked ? (
                      ...
                      <div className={`${currentSubject.bgColor} ${currentSubject.iconColor} px-6 py-3 rounded-lg font-medium`}>
                        <CheckCircle className="h-4 w-4 mr-2 inline" />
                        Dokončeno
                      </div>
                    ) : (
                      <button className={`bg-gradient-to-r ${currentSubject.color} text-white px-6 py-3 rounded-lg font-medium hover:shadow-lg transition-all duration-300 flex items-center`}>
        ...
        <div className="mt-12 text-center">
          <div className="bg-white dark:bg-zinc-800 rounded-2xl border border-gray-200 dark:border-zinc-700 p-8">
            ...
            <p className="text-gray-600 dark:text-zinc-400 mb-6">
              Pracujeme na dalších úlohách a cvičeních pro {currentSubject.title.toLowerCase()}.
              Buďte připraveni na nové výzvy!
            </p>
            <Link 
              to="/home"
