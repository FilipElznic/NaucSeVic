...
import { Magnet, Zap, ArrowRight, Thermometer, Scale } from "lucide-react";
  ...
  const levels = [
    {
      ...
      level: "1. - 5. třída",
      description:
        "První setkání s fyzikou v rámci prvouky a přírodovědy. Pozorování přírody, měření času a teploty.",
      icon: Thermometer,
      color: "orange",
      topics: [
        "Měření času a délky",
    ...
    },
    {
      ...
      level: "6. - 9. třída",
      description:
        "Opravdová fyzika začíná. Síla, pohyb, energie, elektřina a magnetismus. Experimenty a výpočty.",
      icon: Magnet,
      color: "teal",
      topics: [
        "Síla a pohyb",
...
export default FyzikaZSSelection;
