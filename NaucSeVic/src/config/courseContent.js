              ...
              content: {
                ...
                tasks: [
                  ...
                  },
                  {
                    id: "l5_t5",
                    question:
                      "Mám 7 bonbónů a chci jich mít 15. Kolik mi chybí?",
                    options: ["7", "8", "9", "6"],
                    correctAnswer: 1,
                    xp: 25,
                  },
                ...
                sections: [
                  {
                    ...
                    image:
                      "[Image showing correct vertical alignment of decimals]",
                  },
                  {
              ...
              content: {
                ...
                tasks: [
                  ...
                  },
                  {
                    id: "c7_l2_t5",
                    question:
                      "Jakou operací zjistíš $x$ v rovnici $x : 2 = 10$?",
                    options: [
                      "Dělením (10 : 2)",
                      "Násobením (10 · 2)",
                      "Sčítáním (10 + 2)",
              ...
              content: {
                ...
                tasks: [
                  ...
                  },
                  {
                    id: "c7_l3_t3",
                    question:
                      "Jsem v 1. patře a jedu o 3 patra dolů. Kde skončím?",
                    options: [
                      "Ve 2. patře",
                      "V patře -2",
                      "V patře -3",
              ...
              content: {
                ...
                tasks: [
                  ...
                  },
                  {
                    id: "c1_l3_t4",
                    question:
                      "Je zápis $30 = 6 \\cdot 5$ prvočíselným rozkladem?",
                    options: [
                      "Ano, je správný.",
                ...
                tasks: [
                  {
                    id: "c1_l5_t1",
                    question:
                      "Najdi nejmenší společný násobek čísel $2$ a $3$.",
                    options: ["$2$", "$3$", "$5$", "$6$"],
                    correctAnswer: 3,
                    xp: 10,
                  },
              ...
              content: {
                ...
                tasks: [
                  ...
                  },
                  {
                    id: "c2_l3_t2",
                    question:
                      "Převeď zlomek $\\frac{10}{20}$ na základní tvar.",
                    options: [
                      "$\\frac{5}{10}$",
                      "$\\frac{2}{4}$",
                      "$\\frac{1}{2}$",
              ...
              content: {
                ...
                tasks: [
                  ...
                  },
                  {
                    id: "c2_l5_t3",
                    question:
                      "Který tvar je přesnější pro zápis jedné třetiny?",
                    options: [
                      "$0,33$",
                      "$0,333$",
                      "$\\frac{1}{3}$",
                ...
                tasks: [
                  {
                    id: "c5_l5_t1",
                    question:
                      "Vytkni největšího společného dělitele: $5x + 15$",
                    options: [
                      "$5(x + 3)$",
                      "$5(x + 15)$",
                      "$x(5 + 15)$",
              ...
              content: {
                ...
                tasks: [
                  ...
                  },
                  {
                    id: "c6_l1_t2",
                    question:
                      "Jakou úpravu provedeš pro vyřešení $x - 8 = 20$?",
                    options: [
              ...
              content: {
                ...
                tasks: [
                  ...
                  },
                  {
                    id: "c6_l4_t5",
                    question:
                      "Otec (40) je 4x starší než syn. Kolik je synovi?",
                    options: [
                      "$4$ roky",
                      "$10$ let ($4 \\cdot x = 40$)",
                      "$15$ let",
              ...
              content: {
                ...
                tasks: [
                  ...
                  },
                  {
                    id: "c7_l1_t4",
                    question:
                      "Mám předpis $y = 2x$. Jaké $y$ vyjde pro $x = 3$?",
                    options: ["$5$", "$6$", "$1$", "$23$"],
                    correctAnswer: 1,
                    xp: 15,
                  },
              ...
              content: {
                ...
                tasks: [
                  ...
                  },
                  {
                    id: "c7_l3_t2",
                    question:
                      "Kterým bodem VŽDY prochází graf přímé úměrnosti?",
                    options: [
                      "$[0; 1]$",
                      "$[1; 1]$",
                      "$[0; 0]$ (počátek)",
              ...
              content: {
                ...
                tasks: [
                  ...
                  },
                  {
                    id: "c8_l1_t3",
                    question:
                      "Kdo platí úrok, když máš peníze na spořicím účtu?",
                    options: [
                      "Ty platíš bance",
                      "Banka platí tobě",
                      "Nikdo nic neplatí",
              ...
              content: {
                ...
                tasks: [
                  ...
                  },
                  {
                    id: "c8_l5_t5",
                    question:
                      "Vypočítej $P(A)$, když mám 3 výherní losy ze 100.",
                    options: [
                      "$3\\,\\%$",
                      "$30\\,\\%$",
                      "$0,3\\,\\%$",
